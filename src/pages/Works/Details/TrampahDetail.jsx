  ...
  return (
    <main className="min-h-screen bg-[#faf8f5] font-sans text-[#1a1a1a]">
      ...
      <header className="mx-auto max-w-5xl px-6 pt-16 md:pt-24">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 md:gap-12">
          ...
          <div className="grid grid-cols-2 gap-x-6 gap-y-7 self-center">
            {META.map((m) => (
              <div key={m.label}>
                <p className="text-[11px] font-medium uppercase tracking-[0.14em] text-[#999999]">
                  {m.label}
                </p>
                <p className="mt-1.5 text-sm leading-snug text-[#1a1a1a]">
                  {m.value}
                </p>
              </div>
            ))}
      ...
      <section className="mx-auto mt-12 max-w-5xl px-6">
        <div className="aspect-[16/9] w-full overflow-hidden rounded-3xl bg-neutral-100 shadow-lg shadow-black/5">
          <img
            src="/works/trampah.png"
      ...
      <section className="border-y border-[#eceae4] bg-white">
        <div className="mx-auto max-w-5xl px-6 py-16 md:py-20">
          <div className="grid grid-cols-1 gap-10 md:grid-cols-[1fr_1.4fr] md:gap-16">
            <h2 className="font-serif text-3xl md:text-4xl">Project Overview</h2>
      ...
      <section className="bg-[#f2f0ea]">
        <div className="mx-auto max-w-5xl px-6 py-16 md:py-20">
          <div className="grid grid-cols-1 gap-10 md:grid-cols-[1fr_1.4fr] md:gap-16">
            <h2 className="font-serif text-3xl md:text-4xl">My Contribution</h2>
            <div>
              {CONTRIBUTIONS.map((c, i) => (
                ...
                >
                  <span className="font-serif text-lg text-[#b8b3a7]">
                    {c.no}
                  </span>
                  <div>
      ...
      <section className="bg-[#f2f0ea]">
        <div className="mx-auto max-w-5xl px-6 py-16 md:py-20">
          ...
          <div className="mt-8 overflow-hidden rounded-3xl bg-[#dce8d5] shadow-lg shadow-green-900/5">
            <img
              src="/works/trampah-screens.png"
      ...
      <section className="mx-auto max-w-5xl px-6 py-16 md:py-24">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 md:gap-16">
          <div>
            <h2 className="font-serif text-3xl md:text-4xl">Outcomes</h2>
          ...
          <div>
            ...
            <div className="relative mt-8">
              <Quote className="absolute -left-1 -top-2 h-6 w-6 text-green-900/15" />
              <p className="pl-6 text-[15px] italic leading-relaxed text-[#666666]">
